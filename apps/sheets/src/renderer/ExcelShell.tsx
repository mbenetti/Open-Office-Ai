...
interface ExcelShellProps {
  ...
  readonly chatList?:
    | ReadonlyArray<{ chatId: string; createdAt: string; preview?: string }>
    | undefined
    ...
    <main className={`app-shell ${isCopilotOpen ? '' : 'copilot-collapsed'}`}>
      ...
      <div className="sheet-body">
        <AiChatPanel
          ...
          {...(onSelectChat !== undefined ? { onSelectChat } : {})}
          {...(onRefreshChatList !== undefined ? { onRefreshChatList } : {})}
    ...
    <div className={`ribbon${collapsed ? ' collapsed' : ''}`}>
      <RibbonGroup label={t('appGroupAiAssistant')}>
        ...
        >
          ...
          <span>
            <strong>Open Office Ai Ai</strong>
          </span>
        </button>
        <button
