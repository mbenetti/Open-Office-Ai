...
export const aiStrings = defineStrings({
  zh: {
    ...
    aiGskLoginBtn: '登录 Open Office Ai',
    ...
    'aiOpen Office AiAccount': 'Open Office Ai 账号',
    aiAccountChecking: '检测中…',
    aiLoggedIn: '已登录',
    aiLoggedInAs: '已登录：{email}',
    aiNotLoggedIn: '未登录（AI 功能需要登录 Open Office Ai 账号）',
    aiWaitingBrowserLogin: '等待浏览器登录…',
    'aiLoginOpen Office Ai': '登录 Open Office Ai',
    aiModel: '模型',
    aiCancel: '取消',
    aiSave: '保存',
    aiUnknownError: '未知错误',
    aiTimeoutError: 'AI 请求超时：网络长时间无响应，已停止。请检查网络后重试',
    aiCreditsExhausted: 'Open Office Ai 积分已用完，请前往 genspark.ai/pricing 充值后重试',
  ...
  en: {
    ...
    aiGskLoginBtn: 'Sign in to Open Office Ai',
    ...
    'aiOpen Office AiAccount': 'Open Office Ai account',
    aiAccountChecking: 'Checking…',
    aiLoggedIn: 'Signed in',
    aiLoggedInAs: 'Signed in: {email}',
    aiNotLoggedIn: 'Not signed in (AI features require a Open Office Ai account)',
    aiWaitingBrowserLogin: 'Waiting for browser sign-in…',
    'aiLoginOpen Office Ai': 'Sign in to Open Office Ai',
    aiModel: 'Model',
    aiCancel: 'Cancel',
    aiSave: 'Save',
    ...
    aiCreditsExhausted:
      'Your Open Office Ai credits have run out. Visit genspark.ai/pricing to top up, then try again',
  ...
  ja: {
    ...
    aiGskLoginBtn: 'Open Office Ai にサインイン',
    ...
    'aiOpen Office AiAccount': 'Open Office Ai アカウント',
    aiAccountChecking: '確認中…',
    aiLoggedIn: 'サインイン済み',
    aiLoggedInAs: 'サインイン済み: {email}',
    aiNotLoggedIn: '未サインイン（AI 機能には Open Office Ai アカウントへのサインインが必要です）',
    aiWaitingBrowserLogin: 'ブラウザーでのサインインを待機中…',
    'aiLoginOpen Office Ai': 'Open Office Ai にサインイン',
    aiModel: 'モデル',
    aiCancel: 'キャンセル',
    aiSave: '保存',
    ...
    aiCreditsExhausted:
      'Open Office Aiクレジットを使い切りました。genspark.ai/pricing でチャージしてから再試行してください',
  ...
  ko: {
    ...
    aiGskLoginBtn: 'Open Office Ai 로그인',
    ...
    'aiOpen Office AiAccount': 'Open Office Ai 계정',
    aiAccountChecking: '확인 중…',
    aiLoggedIn: '로그인됨',
    aiLoggedInAs: '로그인됨: {email}',
    aiNotLoggedIn: '로그인되지 않음(AI 기능을 사용하려면 Open Office Ai 계정 로그인이 필요합니다)',
    aiWaitingBrowserLogin: '브라우저 로그인 대기 중…',
    'aiLoginOpen Office Ai': 'Open Office Ai 로그인',
    aiModel: '모델',
    aiCancel: '취소',
    aiSave: '저장',
    ...
    aiCreditsExhausted:
      'Open Office Ai 크레딧을 모두 사용했습니다. genspark.ai/pricing에서 충전한 후 다시 시도해 주세요',
  ...
  fr: {
    ...
    aiGskLoginBtn: 'Se connecter à Open Office Ai',
    ...
    'aiOpen Office AiAccount': 'Compte Open Office Ai',
    aiAccountChecking: 'Vérification…',
    aiLoggedIn: 'Connecté',
    aiLoggedInAs: 'Connecté : {email}',
    aiNotLoggedIn: 'Non connecté (les fonctions IA nécessitent un compte Open Office Ai)',
    aiWaitingBrowserLogin: 'En attente de la connexion dans le navigateur…',
    'aiLoginOpen Office Ai': 'Se connecter à Open Office Ai',
    aiModel: 'Modèle',
    aiCancel: 'Annuler',
    aiSave: 'Enregistrer',
    ...
    aiCreditsExhausted:
      'Vos crédits Open Office Ai sont épuisés. Rechargez sur genspark.ai/pricing puis réessayez',
  ...
  de: {
    ...
    aiGskLoginBtn: 'Bei Open Office Ai anmelden',
    ...
    'aiOpen Office AiAccount': 'Open Office Ai-Konto',
    aiAccountChecking: 'Wird überprüft…',
    aiLoggedIn: 'Angemeldet',
    aiLoggedInAs: 'Angemeldet: {email}',
    aiNotLoggedIn: 'Nicht angemeldet (KI-Funktionen erfordern ein Open Office Ai-Konto)',
    aiWaitingBrowserLogin: 'Warten auf Anmeldung im Browser…',
    'aiLoginOpen Office Ai': 'Bei Open Office Ai anmelden',
    aiModel: 'Modell',
    aiCancel: 'Abbrechen',
    aiSave: 'Speichern',
    ...
    aiCreditsExhausted:
      'Deine Open Office Ai-Credits sind aufgebraucht. Lade unter genspark.ai/pricing auf und versuche es erneut',
  ...
  es: {
    ...
    aiGskLoginBtn: 'Iniciar sesión en Open Office Ai',
    ...
    'aiOpen Office AiAccount': 'Cuenta de Open Office Ai',
    aiAccountChecking: 'Comprobando…',
    aiLoggedIn: 'Sesión iniciada',
    aiLoggedInAs: 'Sesión iniciada: {email}',
    aiNotLoggedIn: 'Sin sesión iniciada (las funciones de IA requieren una cuenta de Open Office Ai)',
    aiWaitingBrowserLogin: 'Esperando el inicio de sesión en el navegador…',
    'aiLoginOpen Office Ai': 'Iniciar sesión en Open Office Ai',
    aiModel: 'Modelo',
    aiCancel: 'Cancelar',
    aiSave: 'Guardar',
    ...
    aiCreditsExhausted:
      'Tus créditos de Open Office Ai se han agotado. Recarga en genspark.ai/pricing e inténtalo de nuevo',
  ...
  th: {
    ...
    aiGskLoginBtn: 'ลงชื่อเข้าใช้ Open Office Ai',
    ...
    'aiOpen Office AiAccount': 'บัญชี Open Office Ai',
    aiAccountChecking: 'กำลังตรวจสอบ…',
    aiLoggedIn: 'ลงชื่อเข้าใช้แล้ว',
    aiLoggedInAs: 'ลงชื่อเข้าใช้แล้ว: {email}',
    aiNotLoggedIn: 'ยังไม่ได้ลงชื่อเข้าใช้ (ฟีเจอร์ AI ต้องใช้บัญชี Open Office Ai)',
    aiWaitingBrowserLogin: 'กำลังรอการลงชื่อเข้าใช้ในเบราว์เซอร์…',
    'aiLoginOpen Office Ai': 'ลงชื่อเข้าใช้ Open Office Ai',
    aiModel: 'โมเดล',
    aiCancel: 'ยกเลิก',
    aiSave: 'บันทึก',
    ...
    aiCreditsExhausted:
      'เครดิต Open Office Ai ของคุณหมดแล้ว โปรดเติมเครดิตที่ genspark.ai/pricing แล้วลองใหม่',
  ...
  id: {
    ...
    aiGskLoginBtn: 'Masuk ke Open Office Ai',
    ...
    'aiOpen Office AiAccount': 'Akun Open Office Ai',
    aiAccountChecking: 'Memeriksa…',
    aiLoggedIn: 'Sudah masuk',
    aiLoggedInAs: 'Sudah masuk: {email}',
    aiNotLoggedIn: 'Belum masuk (fitur AI memerlukan akun Open Office Ai)',
    aiWaitingBrowserLogin: 'Menunggu proses masuk di browser…',
    'aiLoginOpen Office Ai': 'Masuk ke Open Office Ai',
    aiModel: 'Model',
    aiCancel: 'Batal',
    aiSave: 'Simpan',
    ...
    aiCreditsExhausted:
      'Kredit Open Office Ai Anda telah habis. Isi ulang di genspark.ai/pricing lalu coba lagi',
  ...
  ru: {
    ...
    aiGskLoginBtn: 'Войти в Open Office Ai',
    ...
    'aiOpen Office AiAccount': 'Учётная запись Open Office Ai',
    aiAccountChecking: 'Проверка…',
    aiLoggedIn: 'Вход выполнен',
    aiLoggedInAs: 'Вход выполнен: {email}',
    aiNotLoggedIn: 'Вход не выполнен (для функций ИИ требуется учётная запись Open Office Ai)',
    aiWaitingBrowserLogin: 'Ожидание входа в браузере…',
    'aiLoginOpen Office Ai': 'Войти в Open Office Ai',
    aiModel: 'Модель',
    aiCancel: 'Отмена',
    aiSave: 'Сохранить',
    ...
    aiCreditsExhausted:
      'Кредиты Open Office Ai исчерпаны. Пополните баланс на genspark.ai/pricing и повторите попытку',
  ...
  ar: {
    ...
    aiGskLoginBtn: 'تسجيل الدخول إلى Open Office Ai',
    ...
    'aiOpen Office AiAccount': 'حساب Open Office Ai',
    aiAccountChecking: 'جارٍ التحقق…',
    aiLoggedIn: 'تم تسجيل الدخول',
    aiLoggedInAs: 'تم تسجيل الدخول: {email}',
    aiNotLoggedIn: 'لم يتم تسجيل الدخول (تتطلب ميزات الذكاء الاصطناعي حساب Open Office Ai)',
    aiWaitingBrowserLogin: 'في انتظار تسجيل الدخول من المتصفح…',
    'aiLoginOpen Office Ai': 'تسجيل الدخول إلى Open Office Ai',
    aiModel: 'النموذج',
    aiCancel: 'إلغاء',
    aiSave: 'حفظ',
    ...
    aiCreditsExhausted:
      'نفدت أرصدة Open Office Ai لديك. يرجى إعادة الشحن عبر genspark.ai/pricing ثم المحاولة مجددًا',
  ...
  pt: {
    ...
    aiGskLoginBtn: 'Entrar no Open Office Ai',
    ...
    'aiOpen Office AiAccount': 'Conta Open Office Ai',
    aiAccountChecking: 'Verificando…',
    aiLoggedIn: 'Conectado',
    aiLoggedInAs: 'Conectado: {email}',
    aiNotLoggedIn: 'Não conectado (os recursos de IA exigem uma conta Open Office Ai)',
    aiWaitingBrowserLogin: 'Aguardando login no navegador…',
    'aiLoginOpen Office Ai': 'Entrar no Open Office Ai',
    aiModel: 'Modelo',
    aiCancel: 'Cancelar',
    aiSave: 'Salvar',
    ...
    aiCreditsExhausted:
      'Seus créditos Open Office Ai acabaram. Recarregue em genspark.ai/pricing e tente novamente',
  ...
  it: {
    ...
    aiGskLoginBtn: 'Accedi a Open Office Ai',
    ...
    'aiOpen Office AiAccount': 'Account Open Office Ai',
    aiAccountChecking: 'Verifica in corso…',
    aiLoggedIn: 'Accesso effettuato',
    aiLoggedInAs: 'Accesso effettuato: {email}',
    aiNotLoggedIn: 'Accesso non effettuato (le funzioni IA richiedono un account Open Office Ai)',
    aiWaitingBrowserLogin: "In attesa dell'accesso nel browser…",
    'aiLoginOpen Office Ai': 'Accedi a Open Office Ai',
    aiModel: 'Modello',
    aiCancel: 'Annulla',
    aiSave: 'Salva',
    ...
    aiCreditsExhausted:
      'I tuoi crediti Open Office Ai sono esauriti. Ricarica su genspark.ai/pricing e riprova',
  ...
  pl: {
    ...
    aiGskLoginBtn: 'Zaloguj się do Open Office Ai',
    ...
    'aiOpen Office AiAccount': 'Konto Open Office Ai',
    aiAccountChecking: 'Sprawdzanie…',
    aiLoggedIn: 'Zalogowano',
    aiLoggedInAs: 'Zalogowano: {email}',
    aiNotLoggedIn: 'Nie zalogowano (funkcje AI wymagają konta Open Office Ai)',
    aiWaitingBrowserLogin: 'Oczekiwanie na logowanie w przeglądarce…',
    'aiLoginOpen Office Ai': 'Zaloguj się do Open Office Ai',
    aiModel: 'Model',
    aiCancel: 'Anuluj',
    aiSave: 'Zapisz',
    ...
    aiCreditsExhausted:
      'Twoje kredyty Open Office Ai wyczerpały się. Doładuj konto na genspark.ai/pricing i spróbuj ponownie',
  ...
  nl: {
    ...
    aiGskLoginBtn: 'Aanmelden bij Open Office Ai',
    ...
    aiNotLoggedIn: 'Niet aangemeld (AI-functies vereisen een Open Office Ai-account)',
    aiWaitingBrowserLogin: 'Wachten op aanmelding in de browser…',
    'aiLoginOpen Office Ai': 'Aanmelden bij Open Office Ai',
    aiModel: 'Model',
    aiCancel: 'Annuleren',
    aiSave: 'Opslaan',
    ...
    aiCreditsExhausted:
      'Je Open Office Ai-credits zijn op. Waardeer op via genspark.ai/pricing en probeer het opnieuw',
  ...
  ms: {
    ...
    aiGskLoginBtn: 'Log masuk ke Open Office Ai',
    ...
    'aiOpen Office AiAccount': 'Akaun Open Office Ai',
    aiAccountChecking: 'Sedang menyemak…',
    aiLoggedIn: 'Sudah log masuk',
    aiLoggedInAs: 'Sudah log masuk: {email}',
    aiNotLoggedIn: 'Belum log masuk (ciri AI memerlukan akaun Open Office Ai)',
    aiWaitingBrowserLogin: 'Menunggu log masuk dalam pelayar…',
    'aiLoginOpen Office Ai': 'Log masuk ke Open Office Ai',
    aiModel: 'Model',
    aiCancel: 'Batal',
    aiSave: 'Simpan',
    ...
    aiCreditsExhausted:
      'Kredit Open Office Ai anda telah habis. Tambah nilai di genspark.ai/pricing dan cuba lagi',
  ...
  he: {
    ...
    aiGskLoginBtn: 'התחבר ל-Open Office Ai',
    ...
    'aiOpen Office AiAccount': 'חשבון Open Office Ai',
    aiAccountChecking: 'בודק…',
    aiLoggedIn: 'מחובר',
    aiLoggedInAs: 'מחובר: {email}',
    aiNotLoggedIn: 'לא מחובר (תכונות AI דורשות חשבון Open Office Ai)',
    aiWaitingBrowserLogin: 'ממתין לכניסה בדפדפן…',
    'aiLoginOpen Office Ai': 'כניסה ל-Open Office Ai',
    aiModel: 'מודל',
    aiCancel: 'ביטול',
    aiSave: 'שמירה',
    aiUnknownError: 'שגיאה לא ידועה',
    aiTimeoutError: 'תם הזמן לבקשת ה-AI: אין תגובה מהרשת וההרצה הופסקה. בדוק את החיבור ונסה שוב',
    aiCreditsExhausted: 'קרדיטי Open Office Ai שלך אזלו. טען מחדש ב-genspark.ai/pricing ונסה שוב',
  ...
  hi: {
    ...
    aiGskLoginBtn: 'Open Office Ai में साइन इन करें',
    ...
    'aiOpen Office AiAccount': 'Open Office Ai खाता',
    aiAccountChecking: 'जांच हो रही है…',
    aiLoggedIn: 'साइन इन किया गया',
    aiLoggedInAs: 'साइन इन: {email}',
    aiNotLoggedIn: 'साइन इन नहीं है (AI सुविधाओं के लिए Open Office Ai खाता आवश्यक है)',
    aiWaitingBrowserLogin: 'ब्राउज़र में साइन इन की प्रतीक्षा…',
    'aiLoginOpen Office Ai': 'Open Office Ai में साइन इन करें',
    aiModel: 'मॉडल',
    aiCancel: 'रद्द करें',
    aiSave: 'सहेजें',
    ...
    aiCreditsExhausted:
      'आपके Open Office Ai क्रेडिट समाप्त हो गए हैं। genspark.ai/pricing पर रिचार्ज करें और फिर से प्रयास करें',
  ...
  'zh-TW': {
    ...
    aiGskLoginBtn: '登入 Open Office Ai',
    ...
    'aiOpen Office AiAccount': 'Open Office Ai 帳號',
    aiAccountChecking: '偵測中…',
    aiLoggedIn: '已登入',
    aiLoggedInAs: '已登入：{email}',
    aiNotLoggedIn: '未登入（AI 功能需要登入 Open Office Ai 帳號）',
    aiWaitingBrowserLogin: '等待瀏覽器登入…',
    'aiLoginOpen Office Ai': '登入 Open Office Ai',
    aiModel: '模型',
    aiCancel: '取消',
    aiSave: '儲存',
    aiUnknownError: '未知錯誤',
    aiTimeoutError: 'AI 請求逾時：網路長時間無回應，已停止。請檢查網路後重試',
    aiCreditsExhausted: 'Open Office Ai 點數已用完，請前往 genspark.ai/pricing 儲值後重試',
