...
export const strings = {
  zh: {
    ...
    noContent: '（无内容）',
    // Account
    'accountOpen Office Ai': 'Open Office Ai 账号',
    account: '账号',
    login: '登录',
    'loginOpen Office Ai': '登录 Open Office Ai 账号',
    loggedIn: '已登录',
    'loggedInOpen Office Ai': '已登录 Open Office Ai',
    ...
    loginCopyUrl: '复制登录链接',
    loginCopied: '已复制',
    loginNetworkError: '无法连接 Open Office Ai,请检查网络或代理设置',
    ...
    onbCredits: '活跃贡献者可获得 **1,000+ Open Office Ai 积分**',
    ...
    onbNote3: 'AI 功能可能消耗 Open Office Ai 积分。',
    onbBack: '上一步',
  },
  en: {
    navRecent: 'Recent',
    ...
    untitled: 'Untitled',
    noContent: '(empty)',
    'accountOpen Office Ai': 'Open Office Ai Account',
    account: 'Account',
    login: 'Sign in',
    'loginOpen Office Ai': 'Sign in with Open Office Ai',
    loggedIn: 'Signed in',
    'loggedInOpen Office Ai': 'Signed in to Open Office Ai',
    ...
    loginCopied: 'Copied',
    loginNetworkError: 'Cannot reach Open Office Ai — check your network or proxy settings',
    ...
    onbCredits: 'Active contributors get **1,000+ Open Office Ai credits**',
    ...
    onbNote3: 'AI features may consume Open Office Ai credits.',
    onbBack: 'Back',
  },
  ja: {
    // Sidebar navigation
    ...
    noContent: '（内容なし）',
    // Account
    'accountOpen Office Ai': 'Open Office Ai アカウント',
    account: 'アカウント',
    login: 'サインイン',
    'loginOpen Office Ai': 'Open Office Ai アカウントでサインイン',
    loggedIn: 'サインイン済み',
    'loggedInOpen Office Ai': 'Open Office Ai にサインイン済み',
    waitingLogin:
    ...
    loginCopied: 'コピーしました',
    loginNetworkError:
      'Open Office Ai に接続できません。ネットワークまたはプロキシ設定を確認してください',
    ...
    onbCredits: 'アクティブな貢献者への特典 **1,000+ Open Office Ai クレジット**',
    ...
    onbNote3: 'AI 機能は Open Office Ai クレジットを消費する場合があります。',
    onbBack: '戻る',
  },
  ko: {
    // Sidebar navigation
    ...
    noContent: '(내용 없음)',
    // Account
    'accountOpen Office Ai': 'Open Office Ai 계정',
    account: '계정',
    login: '로그인',
    'loginOpen Office Ai': 'Open Office Ai 계정으로 로그인',
    loggedIn: '로그인됨',
    'loggedInOpen Office Ai': 'Open Office Ai에 로그인됨',
    ...
    loginCopied: '복사됨',
    loginNetworkError: 'Open Office Ai에 연결할 수 없습니다. 네트워크 또는 프록시 설정을 확인하세요',
    ...
    onbCredits: '활발한 기여자를 위한 혜택 **1,000+ Open Office Ai 크레딧**',
    ...
    onbNote3: 'AI 기능은 Open Office Ai 크레딧을 소모할 수 있습니다.',
    onbBack: '이전',
  },
  fr: {
    // Sidebar navigation
    ...
    noContent: '(vide)',
    // Account
    'accountOpen Office Ai': 'Compte Open Office Ai',
    account: 'Compte',
    login: 'Se connecter',
    'loginOpen Office Ai': 'Se connecter avec Open Office Ai',
    loggedIn: 'Connecté',
    'loggedInOpen Office Ai': 'Connecté à Open Office Ai',
    waitingLogin:
    ...
    loginCopied: 'Copié',
    loginNetworkError:
      'Impossible de joindre Open Office Ai — vérifiez votre réseau ou vos paramètres de proxy',
    ...
    onbCredits: 'Les contributeurs actifs reçoivent **1 000+ crédits Open Office Ai**',
    ...
    onbNote3: 'Les fonctions IA peuvent consommer des crédits Open Office Ai.',
    onbBack: 'Retour',
  },
  de: {
    // Sidebar navigation
    ...
    noContent: '(leer)',
    // Account
    'accountOpen Office Ai': 'Open Office Ai-Konto',
    account: 'Konto',
    login: 'Anmelden',
    'loginOpen Office Ai': 'Mit Open Office Ai anmelden',
    loggedIn: 'Angemeldet',
    'loggedInOpen Office Ai': 'Bei Open Office Ai angemeldet',
    waitingLogin:
    ...
    loginCopied: 'Kopiert',
    loginNetworkError:
      'Open Office Ai ist nicht erreichbar — prüfen Sie Netzwerk- oder Proxy-Einstellungen',
    ...
    onbCredits: 'Aktive Mitwirkende erhalten **1.000+ Open Office Ai-Guthaben**',
    ...
    onbNote3: 'KI-Funktionen können Open Office Ai-Credits verbrauchen.',
    onbBack: 'Zurück',
  },
  es: {
    // Sidebar navigation
    ...
    noContent: '(vacío)',
    // Account
    'accountOpen Office Ai': 'Cuenta de Open Office Ai',
    account: 'Cuenta',
    login: 'Iniciar sesión',
    'loginOpen Office Ai': 'Iniciar sesión con Open Office Ai',
    loggedIn: 'Sesión iniciada',
    'loggedInOpen Office Ai': 'Sesión iniciada en Open Office Ai',
    waitingLogin:
    ...
    loginCopied: 'Copiado',
    loginNetworkError:
      'No se puede conectar con Open Office Ai — compruebe su red o la configuración del proxy',
    ...
    onbCredits: 'Los colaboradores activos reciben **1.000+ créditos de Open Office Ai**',
    ...
    onbNote3: 'Las funciones de IA pueden consumir créditos de Open Office Ai.',
    onbBack: 'Atrás',
  },
  th: {
    // Sidebar navigation
    ...
    // Account
    'accountOpen Office Ai': 'บัญชี Open Office Ai',
    account: 'บัญชี',
    login: 'ลงชื่อเข้าใช้',
    'loginOpen Office Ai': 'ลงชื่อเข้าใช้ด้วย Open Office Ai',
    loggedIn: 'ลงชื่อเข้าใช้แล้ว',
    'loggedInOpen Office Ai': 'ลงชื่อเข้าใช้ Open Office Ai แล้ว',
    ...
    loginNetworkError: 'ไม่สามารถเชื่อมต่อ Open Office Ai ได้ โปรดตรวจสอบเครือข่ายหรือการตั้งค่าพร็อกซี',
    ...
    onbCredits: 'ผู้มีส่วนร่วมอย่างต่อเนื่องจะได้รับ **เครดิต Open Office Ai กว่า 1,000**',
    ...
    onbNote3: 'ฟีเจอร์ AI อาจใช้เครดิต Open Office Ai',
    onbBack: 'ย้อนกลับ',
  },
  id: {
    // Sidebar navigation
    ...
    noContent: '(kosong)',
    // Account
    'accountOpen Office Ai': 'Akun Open Office Ai',
    account: 'Akun',
    login: 'Masuk',
    'loginOpen Office Ai': 'Masuk dengan Open Office Ai',
    loggedIn: 'Sudah masuk',
    'loggedInOpen Office Ai': 'Sudah masuk ke Open Office Ai',
    ...
    loginCopied: 'Disalin',
    loginNetworkError:
      'Tidak dapat terhubung ke Open Office Ai — periksa jaringan atau pengaturan proxy Anda',
    ...
    onbCredits: 'Kontributor aktif mendapat **1.000+ kredit Open Office Ai**',
    ...
    onbNote3: 'Fitur AI dapat menggunakan kredit Open Office Ai.',
    onbBack: 'Kembali',
  },
  ru: {
    // Sidebar navigation
    ...
    noContent: '(пусто)',
    // Account
    'accountOpen Office Ai': 'Учётная запись Open Office Ai',
    account: 'Учётная запись',
    login: 'Войти',
    'loginOpen Office Ai': 'Войти через Open Office Ai',
    loggedIn: 'Вход выполнен',
    'loggedInOpen Office Ai': 'Выполнен вход в Open Office Ai',
    ...
    loginNetworkError: 'Не удаётся подключиться к Open Office Ai — проверьте сеть или настройки прокси',
    ...
    onbCredits: 'Активные участники получают **1000+ кредитов Open Office Ai**',
    ...
    onbNote3: 'Функции ИИ могут расходовать кредиты Open Office Ai.',
    onbBack: 'Назад',
  },
  ar: {
    // Sidebar navigation
    ...
    noContent: '(فارغ)',
    // Account
    'accountOpen Office Ai': 'حساب Open Office Ai',
    account: 'الحساب',
    login: 'تسجيل الدخول',
    'loginOpen Office Ai': 'تسجيل الدخول باستخدام Open Office Ai',
    loggedIn: 'تم تسجيل الدخول',
    'loggedInOpen Office Ai': 'تم تسجيل الدخول إلى Open Office Ai',
    ...
    loginNetworkError: 'تعذّر الاتصال بـ Open Office Ai — تحقق من الشبكة أو إعدادات الوكيل',
    ...
    onbCredits: 'يحصل المساهمون النشطون على **+1,000 من أرصدة Open Office Ai**',
    ...
    onbNote3: 'قد تستهلك ميزات الذكاء الاصطناعي أرصدة Open Office Ai.',
    onbBack: 'رجوع',
  },
  pt: {
    navRecent: 'Recentes',
    ...
    untitled: 'Sem título',
    noContent: '(vazio)',
    'accountOpen Office Ai': 'Conta Open Office Ai',
    account: 'Conta',
    login: 'Entrar',
    'loginOpen Office Ai': 'Entrar com a Open Office Ai',
    loggedIn: 'Conectado',
    'loggedInOpen Office Ai': 'Conectado à Open Office Ai',
    ...
    loginCopied: 'Copiado',
    loginNetworkError:
      'Não foi possível conectar ao Open Office Ai — verifique sua rede ou as configurações de proxy',
    ...
    onbCredits: 'Contribuidores ativos recebem **1.000+ créditos Open Office Ai**',
    ...
    onbNote3: 'Os recursos de IA podem consumir créditos Open Office Ai.',
    onbBack: 'Voltar',
  },
  it: {
    navRecent: 'Recenti',
    ...
    noContent: '(vuoto)',
    'accountOpen Office Ai': 'Account Open Office Ai',
    account: 'Account',
    login: 'Accedi',
    'loginOpen Office Ai': 'Accedi con Open Office Ai',
    loggedIn: 'Accesso effettuato',
    'loggedInOpen Office Ai': 'Accesso effettuato a Open Office Ai',
    ...
    loginCopied: 'Copiato',
    loginNetworkError:
      'Impossibile raggiungere Open Office Ai — controlla la rete o le impostazioni del proxy',
    ...
    onbCredits: 'I collaboratori attivi ricevono **1.000+ crediti Open Office Ai**',
    ...
    onbNote3: 'Le funzioni IA possono consumare crediti Open Office Ai.',
    onbBack: 'Indietro',
  },
  pl: {
    navRecent: 'Ostatnie',
    ...
    untitled: 'Bez tytułu',
    noContent: '(pusto)',
    'accountOpen Office Ai': 'Konto Open Office Ai',
    account: 'Konto',
    login: 'Zaloguj się',
    'loginOpen Office Ai': 'Zaloguj się przez Open Office Ai',
    loggedIn: 'Zalogowano',
    'loggedInOpen Office Ai': 'Zalogowano do Open Office Ai',
    waitingLogin:
    ...
    loginNetworkError: 'Nie można połączyć się z Open Office Ai — sprawdź sieć lub ustawienia proxy',
    ...
    onbCredits: 'Aktywni współtwórcy otrzymują **1000+ kredytów Open Office Ai**',
    ...
    onbNote3: 'Funkcje AI mogą zużywać kredyty Open Office Ai.',
    onbBack: 'Wstecz',
  },
  nl: {
    navRecent: 'Recent',
    ...
    account: 'Account',
    login: 'Inloggen',
    'loginOpen Office Ai': 'Inloggen met Open Office Ai',
    loggedIn: 'Ingelogd',
    'loggedInOpen Office Ai': 'Ingelogd bij Open Office Ai',
    ...
    loginNetworkError: 'Kan Open Office Ai niet bereiken — controleer uw netwerk of proxyinstellingen',
    ...
    onbCredits: 'Actieve bijdragers krijgen **1.000+ Open Office Ai-credits**',
    ...
    onbNote3: 'AI-functies kunnen Open Office Ai-credits verbruiken.',
    onbBack: 'Terug',
  },
  ms: {
    navRecent: 'Terkini',
    ...
    noContent: '(kosong)',
    'accountOpen Office Ai': 'Akaun Open Office Ai',
    account: 'Akaun',
    login: 'Log masuk',
    'loginOpen Office Ai': 'Log masuk dengan Open Office Ai',
    loggedIn: 'Telah log masuk',
    'loggedInOpen Office Ai': 'Telah log masuk ke Open Office Ai',
    ...
    loginCopied: 'Disalin',
    loginNetworkError:
      'Tidak dapat menyambung ke Open Office Ai — semak rangkaian atau tetapan proksi anda',
    ...
    onbCredits: 'Penyumbang aktif menerima **1,000+ kredit Open Office Ai**',
    ...
    onbNote3: 'Ciri AI mungkin menggunakan kredit Open Office Ai.',
    onbBack: 'Kembali',
  },
  he: {
    navRecent: 'אחרונים',
    ...
    untitled: 'ללא שם',
    noContent: '(ריק)',
    'accountOpen Office Ai': 'חשבון Open Office Ai',
    account: 'חשבון',
    login: 'התחברות',
    'loginOpen Office Ai': 'התחברות עם Open Office Ai',
    loggedIn: 'מחובר',
    'loggedInOpen Office Ai': 'מחובר ל-Open Office Ai',
    ...
    loginCopied: 'הועתק',
    loginNetworkError: 'לא ניתן להתחבר ל-Open Office Ai — בדקו את הרשת או את הגדרות ה-proxy',
    ...
    onbCredits: 'תורמים פעילים מקבלים **1,000+ נקודות Open Office Ai**',
    ...
    onbNote3: 'תכונות AI עשויות לצרוך קרדיטים של Open Office Ai.',
    onbBack: 'חזרה',
  },
  hi: {
    navRecent: 'हाल के',
    ...
    noContent: '(खाली)',
    'accountOpen Office Ai': 'Open Office Ai खाता',
    account: 'खाता',
    login: 'साइन इन करें',
    'loginOpen Office Ai': 'Open Office Ai से साइन इन करें',
    loggedIn: 'साइन इन हो गया',
    'loggedInOpen Office Ai': 'Open Office Ai में साइन इन है',
    waitingLogin:
    ...
    loginNetworkError: 'Open Office Ai से कनेक्ट नहीं हो सका — नेटवर्क या प्रॉक्सी सेटिंग जांचें',
    ...
    onbCredits: 'सक्रिय योगदानकर्ताओं के लिए **1,000+ Open Office Ai क्रेडिट**',
    ...
    onbNote3: 'AI सुविधाएँ Open Office Ai क्रेडिट खर्च कर सकती हैं।',
    onbBack: 'वापस',
  },
  'zh-TW': {
    navRecent: '最近',
    ...
    untitled: '未命名',
    noContent: '（無內容）',
    'accountOpen Office Ai': 'Open Office Ai 帳號',
    account: '帳號',
    login: '登入',
    'loginOpen Office Ai': '登入 Open Office Ai 帳號',
    loggedIn: '已登入',
    'loggedInOpen Office Ai': '已登入 Open Office Ai',
    ...
    loginCopyUrl: '複製登入連結',
    loginCopied: '已複製',
    loginNetworkError: '無法連線至 Open Office Ai，請檢查網路或代理設定',
    ...
    onbCredits: '活躍貢獻者可獲得 **1,000+ Open Office Ai 點數**',
    onbJoinGenTeam: '加入 GenTeam',
    onbSkip: '略過',
    onbNext: '下一步',
    onbStart: '開始使用',
    ...
    onbNote3: 'AI 功能可能消耗 Open Office Ai 點數。',
    onbBack: '上一步',
  },
} as const
