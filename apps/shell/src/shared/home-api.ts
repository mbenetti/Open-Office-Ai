...
export interface SkillApi {
  ...
  getSkill(name: string): Promise<SkillRecord | null>
  createSkill(name: string, description: string, instructions: string): Promise<
  ...
  ): Promise<{ ok: true; skill: SkillRecord } | { ok: false; error: string }>
  deleteSkill(id: string): Promise<boolean>
}

export interface KnowledgeApi {
  listKnowledgeBases(): Promise<KnowledgeBaseFolder[]>
  createKnowledgeBase(name: string, description?: string): Promise<KnowledgeBaseFolder>
  renameKnowledgeBase(id: string, name: string): Promise<boolean>
  ...
  getDocumentPreview(id: string): Promise<KnowledgeDocumentPreview | null>
  deleteDocument(id: string): Promise<boolean>
  moveDocumentToKb(docId: string, knowledgeBaseId: string): Promise<boolean>
...
export interface HomeApi {
  ...
  /** open the app author's LinkedIn profile in the default browser */
  openLinkedIn(): Promise<void>
  /** open the fork author's GitHub profile in the default browser */
  openGithub(): Promise<void>
  /** Knowledge Base API */
  knowledge?: KnowledgeApi
  /** Reusable AI skills (slash commands) */
  skills?: SkillApi
}
...
export const HOME_CHANNELS = {
  ...
  openLinkedIn: 'home:open-linkedin',
  openGithub: 'home:open-github',
} as const
